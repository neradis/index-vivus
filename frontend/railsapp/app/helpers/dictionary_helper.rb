...
module DictionaryHelper
    ...
    class KeywordSearchServiceRubyMock
        DictEntries = [
            DictionaryEntryRubyMock.new("verbum", 1, "Noun", "das Wort, der Ausdruck, im Plur. die Worte, Ausdrücke, die Rede, im allg."),
            DictionaryEntryRubyMock.new("verbum", 2, "Noun", "A) die bloße Rede, das leere Wort, der Schein, Cic.: alci dare verba, leere Worte bieten = etwas aufbinden, anführen, hintergehen, überlisten, betrügen, hinters Licht führen, täuschen, ein Schnippchen schlagen
...
D) als gramm. t.t., das Verbum, das Zeitwort, verba temporalia"),
            DictionaryEntryRubyMock.new("index", 1, "Noun", "der Anzeiger, 
...
III) Ov.: digitus index, der Zeigefinger"),
            DictionaryEntryRubyMock.new("index", 2, "Noun", "der Anzeiger, insbes.: 
...
3) der Probierstein"),
            DictionaryEntryRubyMock.new("requiro", 1, "Verb", "I) hersuchen, zur Stelle suchen, aufsuchen, 
...
2) übtr.: a) vermissen, b) verlangen, erfordern, für nötig halten"),
            DictionaryEntryRubyMock.new("requiro", 2, "Verb", "II) nach etw. fragen, forschen, nachfragen, nachforschen, sich erkundigen, 
